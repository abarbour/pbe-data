...
- `Effect`,	the random effect group ('Station', or 'Earthquake') <sup id="a1">[1](#f1)</sup>
...
<b id="f1">1</b> Note that the `Effect` terms are the same as in other tables. In other words: 'Station'=='sta4' and 'Earthquake'=='eqid'. [↩](#a1)
